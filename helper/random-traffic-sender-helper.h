...
#ifndef RANDOM_TRAFFIC_SENDER_HELPER_H
#define RANDOM_TRAFFIC_SENDER_HELPER_H
 ...
 * range of nodes.
 */
class RandomTrafficSenderHelper
{
public:
  RandomTrafficSenderHelper ();
...
#endif /* RANDOM_TRAFFIC_SENDER_HELPER_H */
